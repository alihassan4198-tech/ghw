...
func driveTypeFromPlist(infoPlist *diskUtilInfoPlist) DriveType {
	...
	// TODO(alihassan4198-tech): Figure out how to determine floppy and/or CD/optical
	// drive type on Mac
	return dt
}
...
func storageControllerFromPlist(infoPlist *diskUtilInfoPlist) StorageController {
	...
	// TODO(alihassan4198-tech): I don't know if Mac even supports IDE controllers and
